# 🏠 CHAPTER 1: HOME REPAIR MANUAL
## EMERGENCY PLUMBING CLAMPS, ELECTRICAL TROUBLESHOOTING, ROOF PATCHING, AND HAND TOOLS
> **This manual covers essential domestic repairs, structural diagnostics, and off-grid tool maintenance.**

---

### 🚰 SECTION 1: PLUMBING LEAKS EMERGENCY PATCH
A ruptured pipe can dump 10-20 gallons of water per minute inside your home.
1. **Shut Off:** Turn off the main utility water valve near the street curb.
2. **Rubber Cover:** Cut a square patch of rubber from an old tire tube. Place it directly over the leak hole.
3. **Compression:** Secure a metal hose clamp over the rubber patch, or tighten steel wire around it using pliers.
