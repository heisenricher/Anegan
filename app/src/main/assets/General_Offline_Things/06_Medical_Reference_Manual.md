# 🩺 CHAPTER 6: MEDICAL REFERENCE MANUAL
## DIAGNOSTIC VITAL SIGNS, BABY DELIVERY STEPS, AND PRESSURES ULCERS MITIGATION
> **A baseline clinical manual for evaluating illness and injury.**

---

### 🤰 SECTION 1: DELIVERY PREPARATION
1. Clean environment. Wash hands with sterile soap.
2. Wait for the cord to stop pulsing (3-5 minutes).
3. Tie the cord tightly in two spots (3 and 6 inches from belly) and cut between them.
