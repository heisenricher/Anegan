# 🌾 CHAPTER 3: FARMING AND GARDENING MANUAL
## SOIL NUTRITION, HOT COMPOST CYCLES, OP HEIRLOOM SEEDS SAVING, AND OLLA IRRIGATION
> **A complete agricultural guide for off-grid crop production and water conservation.**

---

### 🌱 SECTION 1: HOT COMPOST DYNAMICS
To build rich garden compost in 30 days:
* **Ratio:** Layer **2 parts carbon Browns** (straw, dry leaves) to **1 part nitrogen Greens** (food scraps, fresh grass).
* **Heat:** Keep damp and aerate every 3 days by turning. Center must reach **130°F–150°F** to kill pathogens.
