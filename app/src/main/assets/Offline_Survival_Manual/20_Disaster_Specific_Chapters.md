# 🌪️ CHAPTER 20: DISASTER-SPECIFIC CHAPTERS
## QUARANTINE ENTRY ZONES, FLOOD SAFETY NUMBERS, EARTHQUAKE SHAKE MANEUVERS, AND CIVIL UNREST DEFENSE
> **This chapter outlines immediate, physical escape and defense actions for specific disaster events.**

---

### 🏢 SECTION 1: EARTHQUAKE SHAKE PROTOCOLS

If you feel the ground shake:

```
        [ DROP ] ──► [ COVER ] (Under sturdy table) ──► [ HOLD ON ]
```

1. **Drop:** Get down onto your hands and knees. This position protects you from being knocked over and allows you to move.
2. **Cover:** Crawl under a sturdy desk or table. Cover your head and neck with your arms. If no shelter is nearby, crawl next to an interior wall (away from windows).
3. **Hold On:** Hold onto your shelter with one hand and protect your head/neck with the other. Remain in place until shaking stops.
