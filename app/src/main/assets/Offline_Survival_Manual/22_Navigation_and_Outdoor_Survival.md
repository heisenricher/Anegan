# 🧭 CHAPTER 22: NAVIGATION AND OUTDOOR SURVIVAL
## TOPOGRAPHIC LINES READING, COMPASS DECLINATION CALCULATORS, AND DEBRIS SHELTER LAYERING
> **This manual covers Geographic orientation and survival shelter engineering.**

---

### ⛺ SECTION 1: DEBRIS SHELTER ENGINEERING

A debris shelter acts as a sleeping bag made of natural materials, preserving body heat in freezing weather.

#### Step-by-Step Construction
1. **Find Ridgepole:** Find a strong branch about 8 to 10 feet long. Place one end on a stump or secure it in the fork of a tree at waist height (approx. 3 feet). Lay the other end on the ground.
2. **Build Ribs:** Lean sturdy branches along both sides of the ridgepole to create an A-frame tent shape. Ensure the interior space is just large enough for your body.
3. **Thatch:** Lay at least **2 feet of dry insulating material** (leaves, pine needles, dry ferns, bark) over the frame.
4. **Bed Insulation:** Fill the interior floor with 1 foot of compressed dry leaves. Sleeping directly on cold ground causes rapid hypothermia.
