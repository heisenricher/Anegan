# 📱 CHAPTER 23: TECHNOLOGY OFFLINE
## MESHTASTIC OFF-GRID FREQUENCIES, DIY FARADAY ENVELOPES, AND PHONE BATTERY SAVERS
> **This manual covers LoRa mesh radios, electromagnetic pulse protection, and battery preservation.**

---

### 🛡️ SECTION 1: THE FARADAY CAGE

An Electromagnetic Pulse (EMP) or high-altitude solar flare (coronal mass ejection) can induce high currents in electrical circuits, destroying microchips.

#### DIY Faraday Cage Construction (Step-by-Step)
1. **Source Container:** Find a metal garbage can with a tight-fitting lid.
2. **Insulate Wall:** Line the entire inside of the garbage can with thick, non-conductive cardboard, bubble wrap, or plastic bags. **No electronic device must touch the outer metal wall of the can.**
3. **Wrap Devices:** Wrap your electronics in plastic wrap, then wrap them completely in two layers of heavy-duty aluminum foil.
4. **Pack:** Place the wrapped devices inside the cardboard-lined garbage can. Seal lid seam with aluminum tape.
