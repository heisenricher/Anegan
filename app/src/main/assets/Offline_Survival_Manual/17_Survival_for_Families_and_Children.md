# 👶 CHAPTER 17: SURVIVAL FOR FAMILIES AND CHILDREN
## INFANT CARE SAFETY, POWDERED FORMULA STERILIZATION, ELDERLY DOSAGE LOGS, AND PET KITS
> **This document contains specific checklists for managing the safety of the highly vulnerable.**

---

### 👶 SECTION 1: INFANT CARE & NUTRITION

Infant immune systems are underdeveloped, making them highly susceptible to waterborne pathogens.

#### 1. Feeding Protocol
* **Prioritize Breastfeeding:** If the mother is nursing, continue to breastfeed. It provides clean, sterile hydration and vital antibodies. The mother will need extra water and food intake (approx. 500 extra calories per day).
* **Formula Safety:** If using powdered formula, you must use water that has been boiled at a rolling boil for **1 full minute** and cooled to room temperature. Never mix formula with untreated tap or well water.
* **Sterilizing Gear:** Boil all bottles, nipples, rings, and mixing spoons in a pot of water for 5 minutes before every use. Never reuse bottles without sterilizing them.
